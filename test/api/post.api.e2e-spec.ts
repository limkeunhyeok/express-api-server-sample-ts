...
describe("POST API (e2e)", () => {
  ...
  describe("GET /api/posts/{id}", () => {
    ...
    it("success - find one by id (200)", async () => {
      ...
      const res = await withHeaders(
        req.get(`${apiPath}/${postId}`).expect(200)
      );
    ...
    it("failed - bad request (400) # non-existent post", async () => {
      ...
      // when
      const res = await withHeaders(
        req.get(`${apiPath}/${postId}`).expect(400)
      );
  ...
  describe("PUT /api/posts/{id}", () => {
    ...
    it("success - update post (200)", async () => {
      ...
      // when
      const res = await withHeaders(
        req.put(`${apiPath}/${postId}`).send(params).expect(200)
      );
    ...
    it("failed - bad request (400) # non-existent post", async () => {
      ...
      // when
      const res = await withHeaders(
        req.put(`${apiPath}/${postId}`).send(params).expect(400)
      );
  ...
  describe("DELETE /api/posts/{id}", () => {
    ...
    it("success - delete post (200)", async () => {
      ...
      // when
      const res = await withHeaders(
        req.delete(`${apiPath}/${postId}`).expect(200)
      );
    ...
    it("failed - bad request (400) # non-existent post", async () => {
      ...
      // when
      const res = await withHeaders(
        req.delete(`${apiPath}/${postId}`).expect(400)
      );
